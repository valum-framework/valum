...
[CCode (lower_case_cprefix = "lua_", cheader_filename = "luajit-2.0/lua.h")]
namespace Lua {
	...
	[CCode (cheader_filename = "luajit-2.0/lauxlib.h")]
	...
	public class LuaVM {
		...
		[CCode (cname = "luaL_dofile", cheader_filename = "luajit-2.0/lauxlib.h")]
		public bool do_file (string filename);
		[CCode (cname = "luaL_dostring", cheader_filename = "luajit-2.0/lauxlib.h")]
		public bool do_string (string str);
		[CCode (cname = "luaL_ref", cheader_filename = "luajit-2.0/lauxlib.h")]
		public int reference (int t);
		[CCode (cname = "luaL_unref", cheader_filename = "luajit-2.0/lauxlib.h")]
